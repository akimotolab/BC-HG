...
def calculate_weighted_discounted_rewards(
    ...
    :param n_envs:
    :param weights: Optional weights for each step, Shape: (n_steps, num_envs)
    :return: Discounted rewards, Shape: (n_steps, num_envs)
    """

    if weights is None:
        weights = jnp.ones_like(traj_batch.reward)  # Shape: (n_steps, num_envs)

    def _get_discounted_reward(
        rolling_discounted_rewards: jnp.ndarray,
        transition_and_weight: Tuple[Transition, jnp.ndarray],
    ) -> Tuple[jnp.ndarray, jnp.ndarray]:
        transition, weight = transition_and_weight
        ...
        rolling_discounted_rewards = (
            weight * reward + discount_factor * rolling_discounted_rewards * (1 - done)
...
def calculate_weighted_discounted_baseline_rewards(
    reward_function_params,
    reward_function,
    traj_batch: Transition,
    discount_factor: float,
    ...
    def _get_discounted_baseline_reward(
        ...
        rolling_discounted_rewards = (
            weight * expected_rewards + discount_factor * rolling_discounted_rewards * (1 - done)
        )  # Calculate discounted reward, Shape: (num_envs,)
...
def create_update_step(
    ...
    def update_step(carry, reg_lambda: float) -> Tuple:
        ...
        UL_discounted_rewards = calculate_weighted_discounted_rewards(
        ...
        discounted_rewards_grad = jax.jacfwd(
            calculate_weighted_discounted_rewards,
        )(
            env_params_fixed_xi.incentive_params,
        ...
        discounted_baseline_rewards_grad = jax.jacfwd(
            calculate_weighted_discounted_baseline_rewards,
        )(
            env_params_fixed_xi.incentive_params,
            lambda param, s, a: env.incentive_function(s, a, param),
            traj_batch,
        ...
        br_response_grad = (
            (discounted_rewards_grad - discounted_baseline_rewards_grad) / reg_lambda
        )  # (n_steps, n_envs, |params|)

...
def main(ctxt, cfg):
    ...
    leader_policy = CategoricalMLPPolicy(
        env_spec=env.spec.leader_policy_env_spec,
        hidden_sizes=l_params['policy_hidden_sizes'],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='config/config_sqi.yaml', help='Path to the config file.')

...
class SAC(RLAlgorithm):
    ...
    def train(self, trainer: Trainer):
        ...
        for _ in trainer.step_epochs():
            ...
            for _ in range(trainer.train_args.itr_per_epoch):
                ...
                if (self.replay_buffer.n_transitions_stored >=
                    ...
                    for _ in range(self._gradient_steps_n):
                        policy_loss, qf1_loss, qf2_loss, policy_grad_norm = self.train_once()
            ...
            if trainer.enable_follower_logging:
                self._log_statistics(policy_loss, qf1_loss, qf2_loss, policy_grad_norm)
    ...
    def train_once(self):
        ...
        if self.replay_buffer.n_transitions_stored >= self._min_buffer_size:
            ...
            policy_loss, qf1_loss, qf2_loss, policy_grad_norm = self.optimize_policy(samples)
            self._update_targets()

        return policy_loss, qf1_loss, qf2_loss, policy_grad_norm
    ...
    def _log_statistics(self, policy_loss, qf1_loss, qf2_loss, policy_grad_norm, prefix='Follower'):
        ...
        with tabular.prefix(prefix + '/'):
            ...
            tabular.record('Policy/{}'.format('GradNorm'), float(policy_grad_norm))
